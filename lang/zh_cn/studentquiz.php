...
/**
 * Strings for component 'studentquiz', language 'zh_cn', branch 'MOODLE_34_STABLE'
 *
 * @package   studentquiz
...
$string['creator_anonym_firstname'] = '匿名';
$string['creator_anonym_lastname'] = '学生';
$string['difficulty_all_column_name'] = '社群难度';
$string['difficulty_level_column_name'] = '难度';
$string['difficulty_title'] = '难度条';
$string['emailapprovedbody'] = '尊敬的 {$a->recepientname},

你在课程 \'{$a->coursename}\' 中的学生小测验（StudentQuiz）活动\'{$a->modulename}\'里留的问题\'{$a->questionname}\'  已经于 \'{$a->timestamp}\'被 \'{$a->actorname}\' 批准了。

审阅该问题: {$a->questionurl}。';
$string['emailapprovedsmall'] = '你的问题\'{$a->questionname}\'已被{$a->actorname}批准。';
$string['emailapprovedsubject'] = '问题已被批准：{$a->questionname}';
$string['emailchangedbody'] = '尊敬的{$a->recepientname},

你在课程 \'{$a->coursename}\' 中的学生小测验（StudentQuiz）活动\'{$a->modulename}\'里留的问题\'{$a->questionname}\'  已经于 \'{$a->timestamp}\'被 \'{$a->actorname}\' 修改了。

审阅该问题: {$a->questionurl}。';
$string['emailchangedsmall'] = '你的问题\'{$a->questionname}\' 已被{$a->actorname}修改。';
$string['emailchangedsubject'] = '问题已被修改：{$a->questionname}';
...
$string['emaildeletedbody'] = '尊敬的{$a->recepientname},

你在课程 \'{$a->coursename}\' 中的学生小测验（StudentQuiz）活动\'{$a->modulename}\'里的问题\'{$a->questionname}\'  于 \'{$a->timestamp}\'被 \'{$a->actorname}\' 删除。';
$string['emaildeletedsmall'] = '你的问题\'{$a->questionname}\' 被{$a->actorname}删除。';
$string['emaildeletedsubject'] = '以下问题被删除：{$a->questionname}';
...
$string['emailunapprovedbody'] = '尊敬的{$a->recepientname},

你在课程 \'{$a->coursename}\' 中的学生小测验（StudentQuiz）活动\'{$a->modulename}\'里被批准的问题\'{$a->questionname}\' 于 \'{$a->timestamp}\'被 \'{$a->actorname}\' 撤消批准。

你可以审阅这个问题：{$a->questionurl}。';
$string['emailunapprovedsmall'] = '你被批准的问题\'{$a->questionname}\' 已被{$a->actorname}撤消批准。';
$string['emailunapprovedsubject'] = '以下问题已被撤消批准：{$a->questionname}';
$string['filter'] = '筛选';
...
$string['filter_label_firstname'] = '名';
...
$string['filter_label_practice'] = '尝试';
...
$string['messageprovider:unapproved'] = '问题被撤消批准的通知';
...
$string['no_mydifficulty'] = '资料不详';
$string['no_mylastattempt'] = '资料不详';
$string['no_myrate'] = '资料不详';
...
$string['settings_quizpracticebehaviour'] = '评分和评论';
$string['settings_quizpracticebehaviour_help'] = '允许学生在测验尝试期间评分和评论问题';
$string['settings_quizpracticebehaviour_label'] = '评分和评论';
...
$string['tags'] = '标签';
$string['task_delete_quiz_after_migration'] = '在使用导入或插件更新删除数据后，即刻删除测验活动';
